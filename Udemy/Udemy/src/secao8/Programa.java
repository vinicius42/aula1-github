...
public class Programa {
	...
	public static void main(String[] args) {
		...
		System.out.println("Entre o número de produtos para serem add ao estoque: ");
		int quantidade = leia.nextInt();
		produto.AddProduto(quantidade);// Aqui faz a atualização da quantidade do objeto produto
		
		System.out.println();
		System.out.println("Dados atualizados: " + produto);
		
		System.out.println("Entre o número de produtos para serem removidos ao estoque: ");
